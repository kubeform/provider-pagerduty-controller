...
// +kubebuilder:rbac:groups=service.pagerduty.kubeform.com,resources=dependencies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=service.pagerduty.kubeform.com,resources=dependencies/status,verbs=get;update;patch
...
func (r *DependencyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &servicev1alpha1.Dependency{}); err != nil {
			klog.Error(err, "unable to set up auditor", servicev1alpha1.Dependency{}.APIVersion, servicev1alpha1.Dependency{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&servicev1alpha1.Dependency{}).
