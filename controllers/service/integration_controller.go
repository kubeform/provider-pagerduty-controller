...
// +kubebuilder:rbac:groups=service.pagerduty.kubeform.com,resources=integrations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=service.pagerduty.kubeform.com,resources=integrations/status,verbs=get;update;patch
...
func (r *IntegrationReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Integration")
...
func (r *IntegrationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &servicev1alpha1.Integration{}); err != nil {
			klog.Error(err, "unable to set up auditor", servicev1alpha1.Integration{}.APIVersion, servicev1alpha1.Integration{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&servicev1alpha1.Integration{}).
