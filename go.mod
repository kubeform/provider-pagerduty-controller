module kubeform.dev/provider-pagerduty-controller
...
require (
	...
	kubeform.dev/provider-pagerduty-api v0.4.1-0.20220308121446-160326633dde
...
require (
	...
	github.com/heimweh/go-pagerduty v0.0.0-20211210233744-b65de43109c1 // indirect
