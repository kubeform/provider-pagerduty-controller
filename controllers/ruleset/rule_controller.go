...
// +kubebuilder:rbac:groups=ruleset.pagerduty.kubeform.com,resources=rules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ruleset.pagerduty.kubeform.com,resources=rules/status,verbs=get;update;patch
...
func (r *RuleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &rulesetv1alpha1.Rule{}); err != nil {
			klog.Error(err, "unable to set up auditor", rulesetv1alpha1.Rule{}.APIVersion, rulesetv1alpha1.Rule{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&rulesetv1alpha1.Rule{}).
