...
// +kubebuilder:rbac:groups=user.pagerduty.kubeform.com,resources=users,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=user.pagerduty.kubeform.com,resources=users/status,verbs=get;update;patch
