...
// +kubebuilder:rbac:groups=business.pagerduty.kubeform.com,resources=services,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=business.pagerduty.kubeform.com,resources=services/status,verbs=get;update;patch
...
func (r *ServiceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &businessv1alpha1.Service{}); err != nil {
			klog.Error(err, "unable to set up auditor", businessv1alpha1.Service{}.APIVersion, businessv1alpha1.Service{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&businessv1alpha1.Service{}).
