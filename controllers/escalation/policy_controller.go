...
// +kubebuilder:rbac:groups=escalation.pagerduty.kubeform.com,resources=policies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=escalation.pagerduty.kubeform.com,resources=policies/status,verbs=get;update;patch
...
func (r *PolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &escalationv1alpha1.Policy{}); err != nil {
			klog.Error(err, "unable to set up auditor", escalationv1alpha1.Policy{}.APIVersion, escalationv1alpha1.Policy{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&escalationv1alpha1.Policy{}).
