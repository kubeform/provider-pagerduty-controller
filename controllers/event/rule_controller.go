...
// +kubebuilder:rbac:groups=event.pagerduty.kubeform.com,resources=rules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=event.pagerduty.kubeform.com,resources=rules/status,verbs=get;update;patch
...
func (r *RuleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &eventv1alpha1.Rule{}); err != nil {
			klog.Error(err, "unable to set up auditor", eventv1alpha1.Rule{}.APIVersion, eventv1alpha1.Rule{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&eventv1alpha1.Rule{}).
