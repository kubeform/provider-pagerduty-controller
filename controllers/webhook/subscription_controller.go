...
// +kubebuilder:rbac:groups=webhook.pagerduty.kubeform.com,resources=subscriptions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=webhook.pagerduty.kubeform.com,resources=subscriptions/status,verbs=get;update;patch
...
func (r *SubscriptionReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Subscription")
...
func (r *SubscriptionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &webhookv1alpha1.Subscription{}); err != nil {
			klog.Error(err, "unable to set up auditor", webhookv1alpha1.Subscription{}.APIVersion, webhookv1alpha1.Subscription{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&webhookv1alpha1.Subscription{}).
