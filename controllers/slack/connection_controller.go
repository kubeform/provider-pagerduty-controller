...
// +kubebuilder:rbac:groups=slack.pagerduty.kubeform.com,resources=connections,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=slack.pagerduty.kubeform.com,resources=connections/status,verbs=get;update;patch
...
func (r *ConnectionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &slackv1alpha1.Connection{}); err != nil {
			klog.Error(err, "unable to set up auditor", slackv1alpha1.Connection{}.APIVersion, slackv1alpha1.Connection{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&slackv1alpha1.Connection{}).
