...
// +kubebuilder:rbac:groups=team.pagerduty.kubeform.com,resources=teams,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=team.pagerduty.kubeform.com,resources=teams/status,verbs=get;update;patch
...
func (r *TeamReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &teamv1alpha1.Team{}); err != nil {
			klog.Error(err, "unable to set up auditor", teamv1alpha1.Team{}.APIVersion, teamv1alpha1.Team{}.Kind)
			return err
		}
	}
