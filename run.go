...
import (
	...
	pagerdutyscheme "kubeform.dev/provider-pagerduty-api/client/clientset/versioned/scheme"
...
func init() {
	_ = pagerdutyscheme.AddToScheme(scheme)
...
func NewCmdRun(version string) *cobra.Command {
	cmd := &cobra.Command{
		Use:               "run",
		Short:             "Launch Kubeform pagerduty Provider controller",
		DisableAutoGenTag: true,
		Run: func(cmd *cobra.Command, args []string) {
			klog.Infoln("Starting provider-pagerduty-controller...")
			...
			mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
				...
				LeaderElectionID:       "pagerduty.kubeform.com",
			})
			if err != nil {
