...
// +kubebuilder:rbac:groups=schedule.pagerduty.kubeform.com,resources=schedules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=schedule.pagerduty.kubeform.com,resources=schedules/status,verbs=get;update;patch
...
func (r *ScheduleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &schedulev1alpha1.Schedule{}); err != nil {
			klog.Error(err, "unable to set up auditor", schedulev1alpha1.Schedule{}.APIVersion, schedulev1alpha1.Schedule{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&schedulev1alpha1.Schedule{}).
