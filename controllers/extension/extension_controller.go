...
// +kubebuilder:rbac:groups=extension.pagerduty.kubeform.com,resources=extensions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=extension.pagerduty.kubeform.com,resources=extensions/status,verbs=get;update;patch
...
func (r *ExtensionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &extensionv1alpha1.Extension{}); err != nil {
			klog.Error(err, "unable to set up auditor", extensionv1alpha1.Extension{}.APIVersion, extensionv1alpha1.Extension{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&extensionv1alpha1.Extension{}).
...
func (r *ExtensionReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Extension")
			return nil
		}
		...
		resourceList := &extensionv1alpha1.ExtensionList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Extension")
			return nil
		}
