...
type UserSpecResource struct {
	...
	// +optional
	AvatarURL *string `json:"avatarURL,omitempty" tf:"avatar_url"`
	// +optional
	...
	// +optional
	InvitationSent *bool `json:"invitationSent,omitempty" tf:"invitation_sent"`
	// +optional
	JobTitle *string `json:"jobTitle,omitempty" tf:"job_title"`
