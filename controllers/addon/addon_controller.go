...
// +kubebuilder:rbac:groups=addon.pagerduty.kubeform.com,resources=addons,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=addon.pagerduty.kubeform.com,resources=addons/status,verbs=get;update;patch
...
func (r *AddonReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &addonv1alpha1.Addon{}); err != nil {
			klog.Error(err, "unable to set up auditor", addonv1alpha1.Addon{}.APIVersion, addonv1alpha1.Addon{}.Kind)
			return err
		}
	}
